...
git clone https://github.com/zarishsphere/zs-svc-procedure.git
cd zs-svc-procedure
...
See [docs.zarishsphere.com/api/zs-svc-procedure](https://docs.zarishsphere.com/api/zs-svc-procedure) for the full OpenAPI 3.1 specification.
